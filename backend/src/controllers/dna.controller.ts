  ...
  try {
    ...
    if (files.length === 0) {
      return res.status(200).json({
        favoriteStack: {
          language: 'Not enough data',
          framework: 'Not enough data',
          database: 'Not enough data',
        },
        strengths: {
          backend: 0,
          frontend: 0,
        ...
        topLanguages: [],
        skillGrowthCurve: [0, 0, 0, 0, 0, 0],
        preferredPattern: {
          title: 'Not enough data',
          description: 'Upload and index a project to generate an evidence-based developer profile.',
        },
        stylisticIdentity: {
          title: 'Not enough data',
          tags: [],
